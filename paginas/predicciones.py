...
with st.expander("1️⃣ Preprocesamiento de los datos"):
    ...
    **Distribución de clases**
    ...
    """)
    st.info("""
    Se aplicó una **purga temporal de 10 días** entre Train, Validation y Test para evitar **data leakage**. Esta técnica es especialmente importante en series temporales financieras, ya que las etiquetas utilizan información futura.
    """)
